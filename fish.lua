...
if not getgenv().Config then 
    getgenv().Config = {
        StandInSecretPlace = true, -- Make your character stand in secret place that dev cant find (CTE ON TOP)
        AutoSendMail = {
            Gem = {
                Username = "",
                MinToSend = 2000000,
...
repeat wait() until not plr.PlayerGui:FindFirstChild("__INTRO")
